  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FFFCF2] via-[#FFF8F0] to-[#FFF5EB]">
      ...
      <section className="relative py-20 px-4 overflow-hidden pt-32">
        <div className="absolute inset-0 bg-gradient-to-br from-[rgba(152,168,130,0.1)] via-transparent to-[rgba(101,45,144,0.05)]"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <div className="inline-flex w-16 h-16 bg-gradient-to-br from-[#98A882] to-[#652D90] rounded-2xl items-center justify-center mb-8 shadow-2xl">
              <Church className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#652D90] mb-6 uppercase" style={alfarnFont}>
              Pour les<br />
              <span className="text-[#98A882] text-4xl md:text-5xl lg:text-6xl">Paroisses</span>
            </h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            <img 
              src={`${GITHUB_RAW}/images/pexels-candewesth-32291215.jpg`}
              alt="Paroisse"
